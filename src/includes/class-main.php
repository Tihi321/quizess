...
class Main extends Config {
  ...
  private function detect_gutenberg() {
    $this->loader->add_action( 'admin_enqueue_scripts', $this->general_helper, 'no_gutenberg_deactivation' );
  }
  ...
  private function define_admin_hooks() {
    ...
    $this->loader->add_action( 'add_meta_boxes', $quiz, 'quiz_options_metaboxes' );
    $this->loader->add_action( 'save_post', $quiz, 'quiz_options_metabox_save', 10, 3 );
  ...
  private function define_rest_routes_hooks() {
    $rest_routes_register = new Rest\Rest_Register();
